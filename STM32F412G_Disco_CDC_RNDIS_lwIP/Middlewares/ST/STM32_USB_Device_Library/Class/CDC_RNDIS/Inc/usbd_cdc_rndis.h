...
/** @defgroup usbd_cdc_rndis_Exported_Defines
  * @{
  */
#define CDC_RNDIS_IN_EP                                   0x81U
#define CDC_RNDIS_OUT_EP                                  0x01U
#define CDC_RNDIS_CMD_EP                                  0x82U
...
#define CDC_RNDIS_CMD_PACKET_SIZE                         8   /* Control Endpoint Packet size */

#define CDC_RNDIS_CONFIG_DESC_SIZ                         67
//(75U-8)
#define CDC_RNDIS_DATA_HS_IN_PACKET_SIZE                  CDC_RNDIS_DATA_FS_MAX_PACKET_SIZE
#define CDC_RNDIS_DATA_HS_OUT_PACKET_SIZE                 CDC_RNDIS_DATA_FS_MAX_PACKET_SIZE
...
typedef struct
{
  uint32_t MsgType;					// 0-3
  uint32_t MsgLength;				// 4-7
